...
# INIT section
template = Template()  # Create a template for resources to live in

template.add_description("""\
Deploys a CodePipeline that can be used to deploy CFN template""")
...
lambda_cfn_role = template.add_resource(iam.Role(
    "LambdaCFNRole",
    ...
    Policies=[
        iam.Policy(
            PolicyName="LambdaCFNAccessPolicy",
                ...
                Statement=[
                    ...
                    Statement(
                        ...
                        Resource=[
                            ...
                            Sub("arn:aws:cloudformation:${AWS::Region}:${AWS::AccountId}:stack/UAT-${AWS::StackName}*"),
                ...
                codepipeline.Actions(
                    ...
                    Configuration={
                        ...
                        "UserParameters": Sub(json.dumps({
                            ...
                            "StackName": "dummy-uat",
                            "ConfigFile": "Build::config-uat.json",
                            "TemplatePath": "Build::dummy.json",
                            "Operation": "CREATECHANGESET",
                            "ChangeSet": "UATCBChangeSet",
                        }))
                    },
                    OutputArtifacts=[
                        codepipeline.OutputArtifacts(
            ...
            Actions=[
                codepipeline.Actions(
                    ...
                    Configuration={
                        ...
                        "UserParameters": Sub(json.dumps({
                            "ActionMode": "CREATE_UPDATE",
                            "StackName": "dummy-prod",
                            "ConfigFile": "Build::config-prod.json",
                            "TemplatePath": "Build::dummy.json",
                            "Operation": "CREATECHANGESET",
                            "ChangeSet": "ProdCBChangeSet",
                        }))
                    },
                    OutputArtifacts=[
                        codepipeline.OutputArtifacts(
